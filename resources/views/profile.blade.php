      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand">Medidor de Consumo de Energía - Mi Perfil</a>
          </div>
              ...
              <div class="card card-profile">
                ...
                <div class="card-body">
                  ...
                  <ul>
                    ...
                    <li><strong>Apellido Paterno:</strong> {{ $user->app }}</li>
                    <li><strong>Apellido Materno:</strong> {{ $user->apm }}</li>
                    <li><strong>Email:</strong> {{ $user->email }}</li>
                    <li><strong>Teléfono:</strong> {{ $user->telefono }}</li>
                    <li><strong>Fecha de Nacimiento:</strong> {{ $user->fn }}</li>
                  </ul>
